// Common code for christmas Tree serial connected seahorse lights
...
// Code common to Cuttletree applications


#ifndef CUTTLETREE_INO
#define CUTTLETREE_INO
...
blender (int slices)
{
  ...
  {
    int i;
    // TODO. Why did the old cuttlefish specify 8 instead of 6 here?
